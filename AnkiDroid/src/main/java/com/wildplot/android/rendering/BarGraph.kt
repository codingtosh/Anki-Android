 ...
 */(private val plotSheet: PlotSheet, private val size: Double, private val points: Array<DoubleArray>, private val color: ColorWrap) : Drawable, Legendable {
    private var mName = ""
     ...
     */
    private fun drawBar(x: Double, y: Double, g: GraphicsWrap, field: RectangleWrap, size: Double = this.size) {
        ...
        if (filling) {
            ...
            if (y < 0) {
                g.fillRect(pointUpLeft[0], plotSheet.yToGraphic(0.0, field), pointUpRight[0] - pointUpLeft[0], pointUpLeft[1] - pointBottomLeft[1])
            } else {
            ...
            if (y < 0) {
                g.drawRect(pointUpLeft[0], plotSheet.yToGraphic(0.0, field), pointUpRight[0] - pointUpLeft[0], pointUpLeft[1] - pointBottomLeft[1])
            } else {
